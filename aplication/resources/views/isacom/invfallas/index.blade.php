  	...
  	<div class="row">
		...
		<div class="btn-toolbar" role="toolbar" style="margin-top: 12px;margin-bottom: 3px;">
		    <div class="btn-group" role="group" style="width: 100%;">
				...
				@include('isacom.invfallas.delete')

				<!-- DESCARGAR -->
				@if ($fallas->count() > 0)
		        <a href="{{url('inventario/fallas/descargar')}}">
		        ...
		        <!-- PROCESAR -->
		        @if ($fallas->count() > 0)
		        <a href="{{url('inventario/fallas/procesar')}}">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="table-responsive">
					<table class="table table-striped table-bordered table-condensed table-hover">
                                ...
                                <span class="input-group-addon" 
                                    ...
                                    <div class="col-xs-12 input-group input-group-sm" 
                                        ...
                                        <button type="button" 
                                            ...
                                            <a href="" 
                                            	data-target="#modal-deleteprod-{{$t->id}}" data-toggle="modal">
						...
						@include('isacom.invfallas.deleprod')
						@endforeach
					</table>

					<div align='left'>
						@if (isset($fallas))
		                	{{$fallas->appends(["filtro" => $filtro])->links()}}
		                @endif
		            </div><br>
