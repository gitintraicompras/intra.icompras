	...
	<div class="row">
		<div class="btn-toolbar" role="toolbar" style="margin-top: 12px;margin-bottom: 3px;">
			<div class="btn-group" role="group" style="width: 100%;">
					@if (isset($invent) && $invent->count() > 0)
					@include('isacom.invcliente.search')
					...
					@include('isacom.invcliente.delete')
				@endif
				<!-- CARGAR INVENTARIO -->
				<a href="{{url('/inventario/cliente/cargar')}}">
							...
							@foreach ($invent as $t)
								...
								<tr>
									...
									<td align="right"
		                				...
		                				color: {{$confcli->forecolor}};">
										@if ($t->vmd > 0)
		                            	  {{number_format($t->cantidad/$t->vmd, 2, '.', ',')}}
		                                @else
		                                  0.00
		                                @endif
									</td>
