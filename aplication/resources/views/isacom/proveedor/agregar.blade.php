...
<div class="row col-lg-12 col-md-12 col-sm-12 col-xs-12">
	...
	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
		<div class="form-group">
			...
			<input readonly name="codcli" value="{{$codcli}}" type="text" class="form-control">
		</div>
	</div>
	<!-- CODPROV -->
	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
		<div class="form-group">
			...
			<input readonly name="codprove" value="{{$prove->codprove}}" type="text" class="form-control">
		</div>
	</div>
	...
	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
		<div class="form-group">
			...
			<input readonly  value="{{$prove->descripcion}}" type="text" class="form-control">
		</div>
	</div>
