...
<body>
    ...
    <br>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <center><span style="font-size: 20px;"><b>{{ strtoupper($maeprove->nombre) }}</b></span></center>
    </div>
        ...
        <div class="form-group">
            <div class="row" style="width: 100%;">
                <div class="input-group input-group-sm">
                    ...
                    <input readonly type="text" value="{{$tabla->codcli}}" style="width: 80px; border: 0px; padding-top: 0px;">

                    <span class="input-group-addon" style="border:0px;">&nbsp;&nbsp;</span>
                    <span class="input-group-addon">CLIENTE:</span>
                    <input readonly type="text" value="{{$tabla->nomcli}}" style="width: 450px; border: 0px;padding-top: 0px;">
        ...
        <div class="form-group">
            <div class="row" style="width: 100%;">
                <div class="input-group input-group-sm">
                    ...
                    <input readonly type="text" value="{{$tabla->rif}}" style="width: 120px; border: 0px; padding-top: 0px;">
        ...
        <div class="form-group">
            <div class="row" style="width: 100%;">
                <div class="input-group input-group-sm">
                    ...
                    <input readonly type="text" 
                        value="{{$moneda}} {{number_format($tabla->total/$factor, 2, '.', ',')}}" 
                        style="text-align: right; width: 150px; border: 0px; padding-top: 0px;">      
    ...
    <div class="table-responsive" > 
        ...
        <table style="width: 100%; margin-right: 16px;" border="1" cellpadding="4" cellspacing="0" height="20px" >    
            ...
            <tr>
                ...
                <td align="right">{{number_format($t->neto/$factor, 2, '.', ',')}}</td>
