...
<?php echo Form::open(array('url'=>'/pedidodirecto','method'=>'POST','autocomplete'=>'off', 'id' => 'form' )); ?>
	...
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
	    <div class="form-group">
	    	...
	    	<select name="idpedgrupo" 
	    		...
	    		id="SelClickTipo" >
	    		<option value="NUEVO">CREAR PEDIDO DIRECTO NUEVO</option>
...
<?php echo $__env->make('layouts.menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\intra.icompras\aplication\resources\views/isacom/pedidodirecto/create.blade.php ENDPATH**/ ?>