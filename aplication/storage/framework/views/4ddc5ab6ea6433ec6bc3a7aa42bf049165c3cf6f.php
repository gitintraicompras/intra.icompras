...
<div class="col-md-12">
  	<div class="row">
		...
		<?php if(isset($fallas) && $fallas->count() > 0 ): ?>
		<!-- BARRA DE BOTONES -->
		<div class="btn-toolbar" role="toolbar" style="margin-top: 12px;margin-bottom: 3px;">
		    <div class="btn-group" role="group" style="width: 100%;">

				<?php echo $__env->make('isacom.invfallas.search', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

				<!-- DELETE -->
				<a href="" data-target="#modal-delete-<?php echo e($codcli); ?>" data-toggle="modal">
		            <button class="btn-normal" data-toggle="tooltip" title="Eliminar fallas">Eliminar
		            </button>
				</a>
				<?php echo $__env->make('isacom.invfallas.delete', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

				<!-- DESCARGAR -->
				<?php if($fallas->count() > 0): ?>
		        <a href="<?php echo e(url('inventario/fallas/descargar')); ?>">
		            <button style="margin-right: 3px;" type="button" data-toggle="tooltip" title="Descargar fallas" class="btn-normal">
		                Descargar
		            </button>
		        </a>
		        <?php endif; ?>
		        ...
		        <!-- PROCESAR -->
		        <?php if($fallas->count() > 0): ?>
		        <a href="<?php echo e(url('inventario/fallas/procesar')); ?>">
		            <button style="margin-right: 3px;" type="button" data-toggle="tooltip" title="Procesar fallas y convertirlo en pedido" class="btn-confirmar">
		                Procesar
		            </button>
		        </a>
				<?php endif; ?>
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="table-responsive">
					<table class="table table-striped table-bordered table-condensed table-hover">
						...
						<?php $__currentLoopData = $fallas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<?php
						$cantidad = 0;
						$vmd = 0.0;
                                ...
                                <span class="input-group-addon" 
                                    ...
                                    <div class="col-xs-12 input-group input-group-sm" 
                                        ...
                                        <button type="button" 
                                            ...
                                            <a href="" 
                                            	data-target="#modal-deleteprod-<?php echo e($t->id); ?>" data-toggle="modal">
						...
						<?php echo $__env->make('isacom.invfallas.deleprod', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
						<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					</table>

					<div align='left'>
						<?php if(isset($fallas)): ?>
		                	<?php echo e($fallas->appends(["filtro" => $filtro])->links()); ?>
...
window.onload = function() {
	$('.BtnModificar').on('click',function(e) {
        ...
        if (parseInt(pedir) <= 0) {
            ...
            $.ajax({
                type:'POST',
                url:'./inventario/fallas/modificaritem',
                dataType: 'json', 
                encode  : true,
...
<?php echo $__env->make('layouts.menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\intra.icompras\aplication\resources\views/isacom/invfallas/index.blade.php ENDPATH**/ ?>